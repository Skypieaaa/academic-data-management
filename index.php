...
<body id="page-top">
  ...
  ?>
        <h1>Selamat Datang di Sistem Academic Data Management: <?php echo $_SESSION['username'];
  ?></h1>
  ...
  //Fetch all data dosen from database
  $result = mysqli_query($connection, "SELECT * FROM dosen ORDER BY nip");
  $result_mhs = mysqli_query($connection, "SELECT * FROM mahasiswa, program_studi where mahasiswa.id_prodi = program_studi.id_prodi ORDER BY nrp ASC");
  ?>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal1">
        ...
        <!-- Portfolio Item 2 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal2">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
            </div>
            <img class="img-fluid" src="img/student.png" alt="">
          </div>
        </div>

        <!-- Portfolio Item 3 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal3">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
            </div>
            <img class="img-fluid" src="img/course.png" alt="">
          </div>
        </div>

        <!-- Portfolio Item 4 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal4">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
            </div>
            <img class="img-fluid" src="img/businessman.png" alt="">
          </div>
        </div>

        <!-- Portfolio Item 5 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal5">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
        ...
        <!-- Portfolio Item 6 -->
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal6">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
              <div class="portfolio-item-caption-content text-center text-white">
                <i class="fas fa-plus fa-3x"></i>
              </div>
            </div>
            <img class="img-fluid" src="img/files.png" alt="">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          if(isset($_POST['Submit'])){
          	...
          	$result = mysqli_query($connection, "INSERT INTO contact_me(name,email,phone,me 	ssage) VALUES ('$name', '$email', '$phone', '$message')");
                	...
                	<table class="table table-stripped">
                		...
                		<tbody>
                			...
                			while ($data_dosen = mysqli_fetch_array($result)) {
                				...
                				echo "<td> <a class='btn btn-success' href='edit_dosen.php?nip=$data_dosen[nip]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_dosen.php?nip=$data_dosen[nip]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                			}
                			  ?>
                		</tbody>
                	</table>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mhs = mysqli_fetch_array($result_mhs)) {
                        echo "<tr>";
                        echo "<td>",$no++."</td>";
                        echo "<td>".$data_mhs['nrp']."</td>";
                        echo "<td>".$data_mhs['nama']."</td>";
                        echo "<td>".$data_mhs['tanggal_lahir']."</td>";
                        echo "<td>".$data_mhs['nama_prodi']."</td>";
                        echo "<td> <a class='btn btn-success' href='edit_mhs.php?nrp=$data_mhs[nrp]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_mhs.php?nrp=$data_mhs[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
                <a class="btn btn-primary" href="add_mhs.php">
                  <i class="fas fa-plus fa-fw"></i>
                  Tambah Mahasiswa
                </a>
              </div>
