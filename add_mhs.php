...
<body id ="page-top">
  ...
  $result_prodi = mysqli_query($connection, "SELECT * FROM program_studi ORDER BY id_prodi ASC");
  ...
  if(isset($_POST['Submit'])){
    ...
    $result = mysqli_query($connection, "INSERT INTO mahasiswa (nrp, nama, tanggal_lahir, jenis_kelamin, id_prodi) VALUES ('$nrp', '$nama', '$tanggal_lahir', '$jenis_kelamin', '$id_prodi')");
